...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/kategori1.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Türkçe Pop | Hareketli Şarkılar</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='1'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Dinlerken yerinde duramayacağın en hareketli şarkıları senin için derledik. İşte Ece Mumay, Edis ve Tarkan gibi şarkıcıların hareketli şarkılarının yer aldığı çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='1'")->fetchAll();

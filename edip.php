...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/anadolu5.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Edip Akbayram</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='17'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Anadolu Rock'ın güçlü seslerinden Edip Akbayram'ın benzersiz şarkılarını senin için derledik. İşte Edip Akbayram'ın Aldırma Gönül ve Hasretinle Yandı Gönlüm gibi şarkılarının yer aldığı çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='17'")->fetchAll();

...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/kategori2.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Yabanci Pop | Hareketli Şarkılar</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='2'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Yerinde duramayanlar için yabancı popun en hareketli şarkılarını derledik. İşte Justın Tımberlake, Lady Gaga ve Shakira'nın bomba gibi şarkılarının yer aldığı çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='2'")->fetchAll();

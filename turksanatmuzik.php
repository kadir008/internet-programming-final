...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/kategori7.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Hareketli Türk Sanat Müziği</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='5'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Hareketli Türk Sanat Müziği şarkılarını bu çalma listesinde bulabilirsin. İşte Safiye Ayla, Emel Sayın ve Zeki Müren gibi müzisyenlerin şarkılarını dinleyebileceğin çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">   
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='5'")->fetchAll();

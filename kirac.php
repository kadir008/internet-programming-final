...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/anadolu2.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Kıraç</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='14'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Kıraç'ın en popüler şarkılarını bu çalma listesinde bulabilirsin... İşte Endamın Yeter, Kara Kaş Gözlerin Elmas ve daha nice Kıraç şarkısının yer aldığı çalma listemiz....</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='14'")->fetchAll();

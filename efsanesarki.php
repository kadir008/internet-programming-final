...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/nostalji5.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Efsane Şarkılar</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='11'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Yıllar geçse de eskimeyen muhteşem eserleri senin için derledik. İşte geçmişten günümüze ulaşan efsane şarkılar... </p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='11'")->fetchAll();

...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/kategori4.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Yaz Şarkıları | Hareketli Şarkılar</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='4'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Yaz aylarının vazgeçilmez şarkılarını senin için derledik. İşte Türkçe Pop'un rengarenk, yaz sıcaklığındaki şarkılarını dinleyebileceğin çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='4'")->fetchAll();

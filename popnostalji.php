...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/nostalji1.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Pop Nostalji</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='7'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>70'ler ve 80'lerden özenle seçtiğimiz efsaneleşmiş pop şarkıları senin için derledik. İşte Nesrin Sipahi, Nilüfer ve Semiramis Pekkan gibi unutulmaz şarkıcıların şarkılarının yer aldığı çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='7'")->fetchAll();

...
<section id="tumradyolar">
            <div id="radyogorsel">
               <img src="img/nostalji2.jpg" class="imgradyo">
            </div>     
            <div id="ayrintilar">
                <h1>Anadolu Rock Nostalji</h1>
                <h2>Toplam <?php echo $conn->query("Select COUNT(adi) FROM muzikler WHERE kategori='8'")->fetchColumn(); ?> Şarkı Bulunmaktadır.</h2>
                <p>Cem Karaca'dan Barış Manço'ya kadar birçok Anadolu Rock efsanelerinin şarkılarının yer aldığı çalma listesi...</p> 
            </div>
            <div id="populer">
            ...
            <div id="tablolar">
               <table id="radyotablosu">
                      ...
                      <?php
                        $sira = 1;
                        $muzikler = $conn->query("SELECT * FROM muzikler WHERE kategori='8'")->fetchAll();
